...
pachctl update pipeline --reprocess --jsonnet ./pipelines/create-log-analysis-report.jsonnet --arg inputPipeline="combine-log-analysis" --arg imageVersion="$version"
